    ...
    var SystemHint = {
        ...
        MembersBind: function() {
            ...
            $('#permissions').unbind('click').bind('click', function() {
                window.location.replace('addBirthdayM.html?type=1&addIsUp=1');
            });
            ...
            $('#membertbodys').delegate('input[data-type="update"]', 'click', function() {
                ...
                window.location.replace('addBirthdayM.html?type=1&addIsUp=2');
            });
        ...
        selectListMem: function(data) {
            ...
            for (var i in data) {
                ...
                if (data[i].condition.birthday_end == '') {
                    birthday = '全部会员'
                } else {
                    birthday = data[i].condition.birthday_start + '-' + data[i].condition.birthday_end
                }
                ...
                content += '<tr class="total-tr" id="' + data[i].market_id + '">' +
                    ...
                    '<td class="tdjianju">' + birthday + '</td> ' +
                    '<td class="tdjianju">' + data[i].condition.advance_day + '</td>' +
