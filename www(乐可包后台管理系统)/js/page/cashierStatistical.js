        ...
        //for (var i in data) {
            ...
            for(var y=0;y<thMap.length;y++){
                ...
                //if(ct[_str] ){
                    ...
                    // 显示实收、优惠
                    //_tempOther_rec += "<td  data-type='"+_str+"'>"+ct[_str]+"</td>";
                    _tempOther_rec +="<td class='report_num' data-type='"+_str+"'>"+pay_money.toFixed(2)+"</td>";
                    _tempOther_dis +="<td class='report_num' data-type='"+_str+"'>"+preferential_money.toFixed(2)+"</td>";

                    pref_money += parseFloat(pay_money);
                    you_money += preferential_money;
                /*}else{
                     //_tempOther_rec += "<td>0</td>";
                }*/
            ...
            content +=  '<tr class="total-tr">'+
                    ...
                    '<td class="report_num">'+parseFloat(ct.table_num)+'</td>'+            //桌台数
