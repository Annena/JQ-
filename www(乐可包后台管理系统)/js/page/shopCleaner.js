$(function () {
    ...
    function CleanerList (data,$tbodys) {
        ...
        var otherClass = accAdd(accMul(accMul(num, 4), 134), 4150);// 支付宝 美团 百度 饿了么 3平台优惠 +1400-1200px+3*200
        ...
        for (var i in data) {
            ...
            for (var j in ctBrray) {
                if(data[i].pay_other != undefined && data[i].pay_other[j]){
                    ...
                    other_rec +="<th class='report_num'>"+data[i].pay_other[j].pay_money+"</th>"+
                                "<th class='report_num'>"+num_num+"</th>";
                    other_dis +="<th class='report_num'>"+data[i].pay_other[j].preferential_money+"</th>"+
                                "<th class='report_num'>"+num_num+"</th>";

                    pay_money += parseFloat(data[i].pay_other[j].pay_money);
                    preferential_money += parseFloat(data[i].pay_other[j].preferential_money);
                } else {
                    other_rec  +=  '<th class="report_num">0.00</th><th class="report_num">0</th>';
                    other_dis  +=  '<th class="report_num">0.00</th><th class="report_num">0</th>';
                }
            }
            ...
            content +=  '<tr class="total-tr">'+
                            ...
                            '<th class="report_num">'+parseFloat(data[i].sub_user_price).toFixed(2)+'</th>'+      //会员价优惠
                            '<th class="report_num">'+parseFloat(data[i].sub_user_discount).toFixed(2)+'</th>'+      //会员折扣优惠
                            '<th class="report_num">'+parseFloat(data[i].small_change).toFixed(2)+'</th>'+         //抹零
                            ...
                            '<th class="report_num">'+parseFloat(data[i].give_menu_consume).toFixed(2)+'</th>'+    //赠送
                            other_dis +                        // 自定义支付方式优惠
        ...
        totalContent =  '<tr class="total-trheji">'+
                        ...
                        '<td class="report_num" >'+totalAfterDiscount.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+totalCash.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+cash_num+'</td>'+
                        '<td class="report_num" >'+totalCard.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+card_num+'</td>'+
                        '<td class="report_num" >'+wxpay.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+wxpay_num+'</td>'+
                        '<td class="report_num" >'+alipay.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+alipay_num+'</td>'+
                        
                        '<td class="report_num" >'+totoalprincipal.toFixed(2)+'</td>'+
                        _tempOther_rec+
                        '<td class="report_num" >'+totaldis_money.toFixed(2)+'</td>'+
                        '<th class="report_num" >'+totalMoney.toFixed(2)+'</th>'+
                        '<th class="report_num" >'+totalMoneyDis.toFixed(2)+'</th>'+
                        '<td class="report_num" >'+totalSmallChange.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+totalVoucher.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+voucher_num+'</td>'+
                        '<td class="report_num" >'+totalSubMoney.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+totalpac_money.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+totalsts_money.toFixed(2)+'</td>'+
                        '<td class="report_num" >'+totalgiv_moeny.toFixed(2)+'</td>'+
                        _tempOther_dis+
                        ...
                        '<td class="report_num">'+pay_num+'</td>'+ // 桌台数
                        '<td class="report_num">'+user_num+'</td>'+
                        '<td class="report_num">'+user_money.toFixed(2)+'</td>'+
